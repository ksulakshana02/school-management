            ...
            <div className="w-full xl:w-1/3 flex flex-col gap-4">
                <div className="bg-white p-4 rounded-md">
                    ...
                    <div className="mt-4 flex gap-4 flex-wrap text-xs text-gray-500">
                        ...
                        <Link href="/public" className="p-3 rounded-md bg-cusPurpleLight">Student&apos;s Teachers</Link>
                        <Link href="/public" className="p-3 rounded-md bg-cusYellowLight">Student&apos;s Lessons</Link>
                        <Link href="/public" className="p-3 rounded-md bg-pink-50">Student&apos;s Exams</Link>
                        <Link href="/public" className="p-3 rounded-md bg-cusSkyLight">Student&apos;s Assignments</Link>
                    </div>
                </div>
                <Performance/>
                <Announcement/>
