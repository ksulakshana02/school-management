...
const schema = z.object({
    ...
    phone: z.string().min(1,{message:"Phone number must required!"}),
    address: z.string().min(1,{message:"Address must required!"}),
    bloodType: z.string().min(1,{message:"Blood Type must required!"}),
    birthday: z.date({message:"Birthday must required!"}),
